...
model = AutoModelForCausalLM.from_pretrained(
    model_name,
    device_map={"": "cpu"}  # Utilisation du CPU
)
...
def preprocess_function(examples):
    ...
    # Ajout des labels (même que les input_ids pour la génération de texte)
...
training_args = TrainingArguments(
    ...
    eval_strategy="epoch",  # Evaluation après chaque époque
    ...
    evaluation_strategy="steps",  # Evaluation par étapes
